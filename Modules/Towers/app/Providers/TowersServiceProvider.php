...
class TowersServiceProvider extends ServiceProvider
{
    ...
    protected string $name = 'Towers';

    protected string $nameLower = 'towers';
    ...
    public function boot(): void
    {
        ...
        $this->mergeConfigFrom(__DIR__ . '/../../config/config.php', 'towers');
        $this->loadViewsFrom(module_path($this->name, 'resources/views'), 'Towers');
    }
