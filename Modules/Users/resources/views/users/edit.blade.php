                                                ...
                                                <div class="input-group">
                                                    <div class="custom-file">
                                                        <input type="file" class="custom-file-input" id="picture"
                                                               name="picture"
                                                               onchange="checkImage(this,'{!! __('users.edit.image.title_res')!!}','{!! __('users.edit.image.type')!!}','{!! __('users.edit.image.size',['size'=>config('config.allowed_image_size')])!!}','{!! config('config.allowed_image_size')!!}','{!! __('users.edit.image.save_warning')!!}','{!!$picture!!}')"
