...
@section('content')
    ...
    $type = $conductor->type ?? old('type');
    $cross_section = $conductor->cross_section ?? old('cross_section');
    $diameter = $conductor->diameter ?? old('diameter');
    $mass= $conductor->mass ?? old('mass');
    $model= $conductor->model ?? old('model');
    $temp_exp_coeff = $conductor->temp_exp_coeff ?? old('temp_exp_coeff');

    $allowable_stress_normal = $conductor->allowable_stress_normal  ?? old('allowable_stress_normal');
    $allowable_stress_emergency = $conductor->allowable_stress_emergency ?? old('allowable_stress_emergency');
    $picture = $conductor->picture ?? old('picture');
    ...
    $created_by = ($conductor->createdBy?->username . ', ' . $conductor->createdBy?->name . ' ' . $conductor->createdBy?->surname) ?: '';
    $updated_by = ($conductor->updatedBy?->username . ', ' . $conductor->updatedBy?->name . ' ' . $conductor->updatedBy?->surname) ?: '';
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="col-sm-4">
                                                ...
                                                $input_value = $type;
                                                $input_name = 'type';
                                                $input_desc = __('conductors.type');
                                                $input_desc_long = __('conductors.type_des');
                                                $input_maxlength = '20';
                                                $input_readonly = '';
                                            ...
                                            <div class="col-sm-4">
                                                ...
                                                $input_desc = __('conductors.cross_section');
                                                $input_desc_long = __('conductors.cross_section_des');
                                                $input_maxlength = '20';
                                                $input_readonly = '';
                                                $input_css = 'text-red'; //text-red
                                                $input_mandatory = '*'; //*
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            $input_name = 'diameter';
                                            $input_desc = __('conductors.diameter');
                                            $input_desc_long = __('conductors.diameter_des');
                                            $input_maxlength = '10';
                                            $input_readonly = '';
                                            $input_css = 'text-red'; //text-red
                                            $input_mandatory = '*'; //*
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            $input_value = $mass;
                                            $input_name = 'mass';
                                            $input_desc = __('conductors.mass');
                                            $input_desc_long = __('conductors.mass_des');
                                            $input_maxlength = '10';
                                            $input_readonly = '';
                                            $input_css = 'text-red'; //text-red
                                            $input_mandatory = '*'; //*
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            $input_value = $model;
                                            $input_name = 'model';
                                            $input_desc = __('conductors.model');
                                            $input_desc_long = __('conductors.model_des');
                                            $input_maxlength = '10';
                                            $input_readonly = '';
                                            $input_css = 'text-red'; //text-red
                                            $input_mandatory = '*'; //*
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            $input_desc = __('conductors.temp_exp_coeff');
                                            $input_desc_long = __('conductors.temp_exp_coeff_des');
                                            $input_maxlength = '20';
                                            $input_readonly = '';
                                            $input_css = 'text-red'; //text-red
                                            $input_mandatory = '*'; //*
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            $input_desc = __('conductors.allowable_stress_normal');
                                            $input_desc_long = __('conductors.allowable_stress_normal_des');
                                            $input_maxlength = '20';
                                            $input_readonly = '';
                                            $input_css = 'text-red'; //text-red
                                            $input_mandatory = '*'; //*
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            $input_desc = __('conductors.allowable_stress_emergency');
                                            $input_desc_long = __('conductors.allowable_stress_emergency_des');
                                            $input_maxlength = '20';
                                            $input_readonly = '';
                                            $input_css = 'text-red'; //text-red
                                            $input_mandatory = '*'; //*
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            ...
                                            <div class="form-group">
                                                <label>{!! __('conductors.edit.image.attach')!!}</label>
                                                <div class="input-group">
                                                    <div class="custom-file">
                                                        <input type="file" class="custom-file-input" id="picture"
                                                               name="picture"
                                                               onchange="checkImage(this,'{!! __('conductors.edit.image.title_res')!!}','{!! __('conductors.edit.image.type')!!}','{!! __('conductors.edit.image.size',['size'=>config('conductors.allowed_image_size')])!!}','{!! config('conductors.allowed_image_size')!!}','{!! __('conductors.edit.image.save_warning')!!}','{!!$picture!!}')"
                                            ...
                                            <div class="form-group" id="picture_content" name="picture_content"
                                                ...
                                                <div class="time-label">
                                                    ...
                                                    <a href="#" class="btn btn-outline-danger"
                                                       onclick="delPhoto('{!! __('conductors.edit.image.delete_warning')!!}','{{$picture}}')"
                                                       title="{{__('conductors.edit.image.detach')}}">
