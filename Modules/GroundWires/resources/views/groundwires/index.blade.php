...
@section('content')
    ...
    $listing = app('request')->input('listing', config('groundwires.pagination'));
    ...
    ?>
    @include('GroundWires::groundwires._include-functions.function-highlight-search')
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-12 col-md-1 col-lg-1 col-xl-1">
                                    <?php
                                    $name = 'id';
                                    $desc = __('groundwires.id');
                                    $desc_long = __('groundwires.id_des');
                                    $maxlength = 100;
                                ...
                                <div class="col-sm-12 col-md-2 col-lg-2 col-xl-2">
                                    <?php
                                    $name = 'type';
                                    $desc = __('groundwires.type');
                                    $desc_long = __('groundwires.type_des');
                                    $maxlength = 100;
                                ...
                                <div class="col-sm-12 col-md-2 col-lg-2 col-xl-2">
                                    <?php
                                    $name = 'diameter';
                                    $desc = __('groundwires.diameter');
                                    $desc_long = __('groundwires.diameter_des');
                                    $maxlength = 100;
                                ...
                                <div class="col-sm-12 col-md-2 col-lg-2 col-xl-2">
                                    <?php
                                    $name = 'mass';
                                    $desc = __('groundwires.mass');
                                    $desc_long = __('groundwires.mass_des');
                                    $maxlength = 20;
                                ...
                                <div class="col-sm-12 col-md-2 col-lg-2 col-xl-2">
                                    <?php
                                    $name = 'model';
                                    $desc = __('groundwires.model');
                                    $desc_long = __('groundwires.model_des');
                                    $maxlength = 20;
                                ...
                                <div class="col-sm-12 col-md-2 col-lg-2 col-xl-2">
                                    <?php
                                    $name = 'temp_exp_coeff';
                                    $desc = __('groundwires.temp_exp_coeff');
                                    $desc_long = __('groundwires.temp_exp_coeff_des');
                                    $maxlength = 20;
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-md-2 col-lg-2 col-xl-2">
                                    ...
                                    $desc = __('groundwires.allowable_stress_normal');
                                    $desc_long = __('groundwires.allowable_stress_normal_des');
                                    $maxlength = 20;
                                ...
                                <div class="col-sm-12 col-md-2 col-lg-2 col-xl-2">
                                    ...
                                    $desc = __('groundwires.allowable_stress_emergency');
                                    $desc_long = __('groundwires.allowable_stress_emergency_des');
                                    $maxlength = 20;
                            ...
                            <div class="dataTables_wrapper dt-bootstrap4">
                                ...
                                <div class="row">
                                    <div class="col-sm-7 col-md-6  col-lg-5 col-xl-4">
                                        {{__('global.show_from')}}
                                        <strong> <span
                                                class="badge badge-warning">{{ $groundwires->firstItem() }}</span></strong>
                                        {{__('global.to')}}
                                        <strong> <span
                                                class="badge badge-warning">{{$groundwires->lastItem() }}</span></strong>
                                        ({{__('global.sum')}}
                                        <strong> <span
                                                class="badge badge-danger">{{ $groundwires->total() }}</span></strong>
                                        {{__('global.records')}})
                                    </div>
                                </div>
                                <!-- Page end =============================================================================================== -->
                                        ...
                                        <table id="example2" class="table_grid">
                                            ...
                                            <tr>
                                                {{-- ========================================================================--}}
                                                    <?php
                                                    $column_name = 'id';
                                                    $column_desc = __('groundwires.id');
                                                    $column_desc_long = __('groundwires.id_des');
                                                ...
                                                {{-- ========================================================================--}}
                                                    <?php
                                                    $column_name = 'type';
                                                    $column_desc = __('groundwires.type');
                                                    $column_desc_long = __('groundwires.type_des');
                                                    $query_sort = request()->query('sort');
                                                    $style_acs_desc = match (true) {
                                                        $query_sort == 'asc' && $order == $column_name => 'asc',
                                                        $query_sort == 'desc' && $order == $column_name => 'desc',
                                                ...
                                                {{-- ========================================================================--}}
                                                    ...
                                                    $column_desc = __('groundwires.cross_section');
                                                    $column_desc_long = __('groundwires.cross_section_des');
                                                    $query_sort = request()->query('sort');
                                                    $style_acs_desc = match (true) {
                                                        $query_sort == 'asc' && $order == $column_name => 'asc',
                                                        $query_sort == 'desc' && $order == $column_name => 'desc',
                                                ...
                                                {{-- ========================================================================--}}
                                                    ...
                                                    $column_desc = __('groundwires.diameter');
                                                    $column_desc_long = __('groundwires.diameter_des');
                                                    $query_sort = request()->query('sort');
                                                    $style_acs_desc = match (true) {
                                                        $query_sort == 'asc' && $order == $column_name => 'asc',
                                                        $query_sort == 'desc' && $order == $column_name => 'desc',
                                                ...
                                                {{-- ========================================================================--}}
                                                    <?php
                                                    $column_name = 'mass';
                                                    $column_desc = __('groundwires.mass');
                                                    $column_desc_long = __('groundwires.mass_des');
                                                    $query_sort = request()->query('sort');
                                                    $style_acs_desc = match (true) {
                                                        $query_sort == 'asc' && $order == $column_name => 'asc',
                                                        $query_sort == 'desc' && $order == $column_name => 'desc',
                                                ...
                                                {{-- ========================================================================--}}
                                                    <?php
                                                    $column_name = 'model';
                                                    $column_desc = __('groundwires.model');
                                                    $column_desc_long = __('groundwires.model_des');
                                                    $query_sort = request()->query('sort');
                                                    $style_acs_desc = match (true) {
                                                        $query_sort == 'asc' && $order == $column_name => 'asc',
                                                        $query_sort == 'desc' && $order == $column_name => 'desc',
                                                ...
                                                {{-- ========================================================================--}}
                                                    ...
                                                    $column_desc = __('groundwires.temp_exp_coeff');
                                                    $column_desc_long = __('groundwires.temp_exp_coeff_des');
                                                    $query_sort = request()->query('sort');
                                                    $style_acs_desc = match (true) {
                                                        $query_sort == 'asc' && $order == $column_name => 'asc',
                                                        $query_sort == 'desc' && $order == $column_name => 'desc',
                                                ...
                                                {{-- ========================================================================--}}
                                                    ...
                                                    $column_desc = __('groundwires.allowable_stress_normal');
                                                    $column_desc_long = __('groundwires.allowable_stress_normal_des');
                                                    $query_sort = request()->query('sort');
                                                    $style_acs_desc = match (true) {
                                                        $query_sort == 'asc' && $order == $column_name => 'asc',
                                                        $query_sort == 'desc' && $order == $column_name => 'desc',
                                                ...
                                                {{-- ========================================================================--}}
                                                    ...
                                                    $column_desc = __('groundwires.allowable_stress_emergency');
                                                    $column_desc_long = __('groundwires.allowable_stress_emergency_des');
                                                    $query_sort = request()->query('sort');
                                                    $style_acs_desc = match (true) {
                                                        $query_sort == 'asc' && $order == $column_name => 'asc',
                                                        $query_sort == 'desc' && $order == $column_name => 'desc',
                                            ...
                                            <tbody>
                                            @foreach($groundwires as $conductor)
...
{{--                                        <a class="btn btn-default btn-sm"
                                    ...
                                    <div class="col-sm-6 col-md-6">
                                        <div class="pagination pagination-sm float-right">
                                            {{ $groundwires->withQueryString()->links('pagination::bootstrap-4')  }}
                                        </div>
